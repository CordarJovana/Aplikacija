...
//Funkcije za prikaz
    public function vratiSveDoktore(){
        $this->izvrsiUpit("select d.*, kat.naziv as 'naziv', kat.idkategorije as 'kat_id' from doktori d inner join kategorijedoktora kat on (kat.idkategorije=d.idkategorije)");
